...
#       :ssothoutrea, :ssothbcounth, :ssothbcsec, :ssothwareh, :ssothelcom, :ssothphbank, :ssothwebsite, :ssothcpst, :ssothoth, :ssothcomment,  :election_year_id, :county, :current_step
#       )
#     end
# end
