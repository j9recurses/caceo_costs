...
validates   :salbcinh, :salbcamor, :salbcchca, :salbcsec, :sabcoth, :salbcpsrp, :salbcpsop, :salbctsrp, :salbctsop, :salbctothrs, :salbchrsps, :salbchrsts,   numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 10000000,  :allow_nil => true, :allow_blank => false,  message: " Entry is not valid. Please check your entry"  }
validates :salbctot, :salbctotbe, :salbctotbep, :salbcbeps, :salbcbepsp, :salbcbets, :salbcbetsp, numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 100,  :allow_nil => true, :allow_blank => false,  message: 'Entry is not valid. Please check your entry'  }
