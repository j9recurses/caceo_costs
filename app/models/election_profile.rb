...
validates  :epicrp, numericality: { less_than_or_equal_to: 9999.99, greater_than_or_equal_to: 0.01, :allow_nil => true, :allow_blank => false,  message: 'Indirect cost rate is expected to be between 9999.99 and 0.01' }
