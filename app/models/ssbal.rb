...
validates :ssbalpriprou, numericality: { less_than_or_equal_to: 9.99, greater_than_or_equal_to: 0.01, :allow_nil => true, :allow_blank => false,  message: 'Unit price expected to be between 9.99 and 0.01' }
