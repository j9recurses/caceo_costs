...
validates   :salothvoed, :salothvore, :salothelcal, :salothstind, :salothvoros, :salother, :salothtot, :salothpsrp, :salothpsop, :salothtsrp, :salothtsop, :salothhrs, :salothhrsps, :salothhrsts,   numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 10000000,  :allow_nil => true, :allow_blank => false,  message: " Entry is not valid. Please check your entry"  }
validates :salothbe, :salothbep, :salothbeps, :salothbepsp, :salothbets, :salothbetsp, numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 100,  :allow_nil => true, :allow_blank => false,  message: 'Entry is not valid. Please check your entry'  }
