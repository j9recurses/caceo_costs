...
validates   :salvbmoutr, :salvbmappro, :salvbmuoapp, :salvbmusps, :salvbmproces, :salvbmoth, :salvbmpsrp, :salvbmpsop, :salvbmtsrp, :salvbmtsop, :salvbmtothrs, :salvbmhrsps, :salvbmhrsts,   numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 10000000,  :allow_nil => true, :allow_blank => false,  message: " Entry is not valid. Please check your entry"  }
validates :salvbmtot, :salvbmtotbe, :salvbmtotbep, :salvbmbeps, :salvbmbepsp, :salvbmbets, :salvbmbetsp, numericality:{only_integer: true, :greater_than_or_equal_to => 0, :less_than_or_equal_to  => 100,  :allow_nil => true, :allow_blank => false,  message: 'Entry is not valid. Please check your entry'  }
