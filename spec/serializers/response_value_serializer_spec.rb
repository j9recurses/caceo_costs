...
RSpec.describe 'ResponseValueSerializer' do
  ...
  describe 'associations' do
    ...
    it 'are question and survey_response' do
      expect(@relationships.keys.sort).to eq([:question])
    end
    ...
    # # Spec no longer includes survey_response id in response_value
    # it 'include correct question' do
  ...
  describe 'attributes' do
    ...
    it 'include :value, :data_type, :field, :na_value' do
      expect(@attributes.keys.sort).to eq([:data_type, :na_value, :value])
    end
